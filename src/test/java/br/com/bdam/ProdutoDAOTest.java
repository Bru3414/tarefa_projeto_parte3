...
public class ProdutoDAOTest {
	...
	private Produto criarProduto(String codigo, String nome) throws TipoChaveNaoEncontradaException, DAOException {
	...
	public void pesquisar() throws MaisDeUmRegistroException, TableException, DAOException, TipoChaveNaoEncontradaException {
		Produto produto = criarProduto("A1", "Produto 1");
	...
	public void salvar() throws TipoChaveNaoEncontradaException, DAOException {
		Produto produto = criarProduto("A2" , "Produto 2");
		Assert.assertNotNull(produto);
	...
	public void excluir() throws DAOException, TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException {
		Produto produto = criarProduto("A3", "Produto 3");
		Assert.assertNotNull(produto);
		excluir(produto.getCodigo());
	...
	public void alterarCliente() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TableException {
		Produto produto = criarProduto("A4", "Produto 4");
	...
	public void buscarTodos() throws DAOException, TipoChaveNaoEncontradaException {
		criarProduto("A5", "Produto 5");
		criarProduto("A6", "Produto 6");
		Collection<Produto> list = produtoDao.buscarTodos();
