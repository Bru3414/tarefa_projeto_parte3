...
import br.com.bdam.dao.IVendaDAO;
import br.com.bdam.dao.ProdutoDAO;
import br.com.bdam.dao.VendaDAO;
...
import br.com.bdam.domain.Venda.Status;
...
public class VendaDAOTest {
	...
	public void init() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		this.produto = cadastrarProduto("A1", BigDecimal.TEN, "Produto 1");
	}
	...
	public void adicionarMaisProdutosDiferentes() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		Produto prod = cadastrarProduto(codigoVenda, BigDecimal.valueOf(50), "Produto 5");
		assertNotNull(prod);
	...
	public void removerProduto() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		Produto prod = cadastrarProduto(codigoVenda, BigDecimal.valueOf(50), "Produto 7");
		assertNotNull(prod);
		assertEquals(codigoVenda, prod.getCodigo());
	...
	public void removerApenasUmProduto() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		Produto prod = cadastrarProduto(codigoVenda, BigDecimal.valueOf(50), "Produto 8");
		assertNotNull(prod);
		assertEquals(codigoVenda, prod.getCodigo());
	...
	public void removerTodosProdutos() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		...
		Produto prod = cadastrarProduto(codigoVenda, BigDecimal.valueOf(50), "Produto 9");
		assertNotNull(prod);
		assertEquals(codigoVenda, prod.getCodigo());
	...
	private Produto cadastrarProduto(String codigo, BigDecimal valor, String nome) throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
		Produto produto = new Produto();
		produto.setCodigo(codigo);
		produto.setDescricao("Produto 1");
		produto.setNome(nome);
		produto.setValor(valor);
		produto.setFornecedor("Fornecedor 1");
